...
class Zfmyadmin_Validate_ModuleNoExist extends Zfmyadmin_Validate_Abstract
{ 
     ...
     * @const string
     */    
    const MODULE_EXIST = 'moduleExists';
    ...
    public function isValid($value)
    {
        ...
        if (!empty($module->name)) {
            $this->_error( self::MODULE_EXIST, $this->translate('Module already exists!'));
            return false;
        }        
        return true;
    }
