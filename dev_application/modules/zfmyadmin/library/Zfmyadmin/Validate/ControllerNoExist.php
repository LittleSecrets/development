...
class Zfmyadmin_Validate_ControllerNoExist extends Zfmyadmin_Validate_Abstract
{ 
     ...
     * @const string
     */    
    const CONTROLLER_EXIST = 'fileExists';
    ...
    public function isValid($value)
    {
        ...
        if (file_exists($this->_controllersPath . DIRECTORY_SEPARATOR . $value)) {
                $this->_error( self::CONTROLLER_EXIST, $this->translate('In this module such controller already exists!'));
                return false;
            }        
        return true;
    }
